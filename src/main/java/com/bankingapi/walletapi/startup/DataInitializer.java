package com.bankingapi.walletapi.startup;
...
public class DataInitializer implements CommandLineRunner{
    ...
    public DataInitializer(BankAccountRepository bankAccountRepository, UserRepository userRepository, TransactionRepository transactionRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userRepository.count() > 0 || bankAccountRepository.count() > 0 || transactionRepository.count() > 0) {
            return;
        }
